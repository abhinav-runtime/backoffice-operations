...
public class CustomerController {
	...
	@GetMapping
	public List<CustomerResponseDTO> getAllCustomers(@RequestHeader(HttpHeaders.AUTHORIZATION)  String token) {
		List<Customer> customers = customerRepository.findAll();
		return customers.stream().map(this::mapToResponseDTO).collect(Collectors.toList());
	}
	...
	@PutMapping("/{custId}")
	public CustomerResponseDTO updateCustomer(@PathVariable String custId,
			@RequestBody CustomerRequestDTO updatedCustomerDTO) {
