...
@RestController
@RequestMapping("/api/v1/annexure-transfer-limits")
public class AnnexureTransferLimitController {
	...
	public GenericResponseDTO<Object> updateAnnexureTransferLimits(@PathVariable(name = "id") String id,
			@RequestBody AnnexureTransferLimitsDTO requestDTO) {
