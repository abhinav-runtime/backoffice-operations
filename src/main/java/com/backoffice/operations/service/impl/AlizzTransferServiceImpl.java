...
public class AlizzTransferServiceImpl implements AlizzTransferService {
    ...
    private AlizzTransferDto.Sender getSenderDetails(AlizzTransferRequestDto alizzTransferRequestDto, AccountDetails.Response.Payload.CustSummaryDetails.IslamicAccount senderAccDetails, BeneficiaryBank beneficiaryBank) {
    ...
    private AlizzTransferDto.Transaction getTransactionDetails(AlizzTransferRequestDto alizzTransferRequestDto, String txnRefId, AccountCurrency accountCurrency, TransferAccountFields transferAccountFields, String trnxDate) {
