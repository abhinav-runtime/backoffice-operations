...
//									String newOtp = CommonUtils.generateRandomOtp();
                                ...
                                validationResultDTO.setStatus("Failure");
                                validationResultDTO.setMessage("Please verify card first/last four digits.");
                                data.setUniqueKey(entityIdDTO.getUniqueKey());
                                validationResultDTO.setData(data);
                                return validationResultDTO;
                            }
    ...
    private static CardEntity getCardEntity(Card card, Optional<CivilIdEntity> civilIdEntity, ResponseEntity<ExternalApiResponseDTO> responseEntity) {
