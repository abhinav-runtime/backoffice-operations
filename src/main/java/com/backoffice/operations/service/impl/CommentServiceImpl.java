...
import com.backoffice.operations.repository.CommentRepository;
import com.backoffice.operations.repository.PostRepository;
...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public CommentDto updateComment(String postId, String commentId, CommentDto commentRequest) {
        // retrieve post entity by id
        Post post = postRepository.findById(postId).orElseThrow(
                () -> new ResourceNotFoundException("Post", "id", postId));
